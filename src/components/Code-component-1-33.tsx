      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-primary pl-6">
                <h3 className="text-xl font-semibold text-dark-brown mb-2">Our Story</h3>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 bg-soft-pink rounded-lg">
                  <div className="text-2xl font-bold text-primary mb-1">5+</div>
                  <div className="text-sm text-dark-brown">Years of Excellence</div>
                </div>
                <div className="text-center p-4 bg-soft-pink rounded-lg">
                  <div className="text-2xl font-bold text-primary mb-1">500+</div>
                  <div className="text-sm text-dark-brown">Satisfied Clients</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-dark-brown mb-4">Our Values</h3>
              ...
              return (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 space-y-4">
                    ...
                    <h4 className="text-lg font-semibold text-dark-brown">{value.title}</h4>
