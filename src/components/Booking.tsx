    ...
    <section id="booking" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          <Badge variant="secondary" className="bg-[color:var(--palette-peach)]/25 text-[color:var(--palette-rose)] border-[color:var(--palette-coral)]/30">
            Book Your Visit
          </Badge>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl text-[color:var(--palette-gray)]">Book Your Appointment</CardTitle>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" size="lg" className="w-full bg-[color:var(--palette-rose)] hover:bg-[color:var(--palette-rose)]/90">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <Clock className="h-5 w-5 text-[color:var(--palette-rose)]" />
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <MapPin className="h-5 w-5 text-[color:var(--palette-rose)]" />
                  <span>Contact Info</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Phone className="h-4 w-4 text-[color:var(--palette-coral)]" />
                  <div>
                ...
                <div className="flex items-center space-x-3">
                  <Mail className="h-4 w-4 text-[color:var(--palette-coral)]" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <MapPin className="h-4 w-4 text-[color:var(--palette-coral)] mt-1" />
                  <div>
            ...
            <Card className="bg-[color:var(--palette-peach)]/20 border-[color:var(--palette-coral)]/30">
              <CardContent className="p-6">
                <h3 className="font-semibold text-[color:var(--palette-gray)] mb-2">Booking Policy</h3>
