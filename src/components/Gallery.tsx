      ...
      <div className="container mx-auto px-4">
            ...
            <Card key={index} className="group overflow-hidden hover:shadow-xl transition-all duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <Badge variant="secondary" className="bg-[color:var(--palette-rose)] text-white border-[color:var(--palette-rose)] mb-2">
                    {item.category}
                  </Badge>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white rounded-xl shadow-sm">
            <div className="text-3xl font-bold text-[color:var(--palette-rose)] mb-2">50+</div>
            <div className="text-[color:var(--palette-gray)] font-medium mb-1">Unique Designs</div>
            <div className="text-sm text-muted-foreground">New creations every month</div>
          </div>
          
          <div className="text-center p-6 bg-white rounded-xl shadow-sm">
            <div className="text-3xl font-bold text-[color:var(--palette-coral)] mb-2">100%</div>
            <div className="text-[color:var(--palette-gray)] font-medium mb-1">Custom Work</div>
            <div className="text-sm text-muted-foreground">Tailored to your style</div>
          </div>
          
          <div className="text-center p-6 bg-white rounded-xl shadow-sm">
            <div className="text-3xl font-bold text-[color:var(--palette-mauve)] mb-2">5★</div>
            <div className="text-[color:var(--palette-gray)] font-medium mb-1">Client Rating</div>
